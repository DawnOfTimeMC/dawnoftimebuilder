...
public abstract class DoTBCreativeModeTabsRegistry {
    ...
    public Supplier<CreativeModeTab> DOT_TAB = register("dot_tab", () -> new ItemStack(DoTBItemsRegistry.INSTANCE.DOT_ITEM.get()), Component.translatable("itemGroup." + DoTBCommon.MOD_ID + ".dottab"));
