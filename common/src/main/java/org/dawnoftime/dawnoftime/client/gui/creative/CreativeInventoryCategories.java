...
public enum CreativeInventoryCategories {
    ...
    public record SubTab(String nameKey, ResourceLocation textureOn, ResourceLocation textureOff, List<Item> items) {
        public SubTab(String nameKey, Item... items) {
            this(nameKey,
                    ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/gui/subtab_" + nameKey + "_on.png"),
                    ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/gui/subtab_" + nameKey + "_off.png"),
                    Arrays.asList(items));
        }
