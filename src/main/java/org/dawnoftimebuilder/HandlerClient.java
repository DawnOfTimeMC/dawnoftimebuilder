...
public class HandlerClient
{
	...
	public static void fMLClientSetupEvent(final FMLClientSetupEvent event)
	{
		...
		RenderingRegistry.registerEntityRenderingHandler(DoTBEntitiesRegistry.SILKMOTH_ENTITY.get(),
				SilkmothRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(DoTBEntitiesRegistry.JAPANESE_DRAGON_ENTITY.get(),
				JapaneseDragonRenderer::new);
