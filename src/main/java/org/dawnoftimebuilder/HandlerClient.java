...
public class HandlerClient {
	...
	public static void registerTabs() {
		register(ItemGroup.TAB_BUILDING_BLOCKS, new ResourceLocation("building_blocks/variations"), new ItemStack(Blocks.OAK_PLANKS));
		...
		register(DawnOfTimeBuilder.DOTB_TAB, new ResourceLocation("dawnoftimebuilder", "dotblocks/general"), new ItemStack(((Item) DoTBItemsRegistry.GENERAL.get()).asItem()));
		register(DawnOfTimeBuilder.DOTB_TAB, new ResourceLocation("dawnoftimebuilder", "dotblocks/egyptian"), new ItemStack(((Item)DoTBItemsRegistry.EGYPTIAN.get()).asItem()));
		register(DawnOfTimeBuilder.DOTB_TAB, new ResourceLocation("dawnoftimebuilder", "dotblocks/french"), new ItemStack(((Item)DoTBItemsRegistry.FRENCH.get()).asItem()));
		register(DawnOfTimeBuilder.DOTB_TAB, new ResourceLocation("dawnoftimebuilder", "dotblocks/german"), new ItemStack(((Item)DoTBItemsRegistry.GERMAN.get()).asItem()));
		register(DawnOfTimeBuilder.DOTB_TAB, new ResourceLocation("dawnoftimebuilder", "dotblocks/persian"), new ItemStack(((Item)DoTBItemsRegistry.PERSIAN.get()).asItem()));
		register(DawnOfTimeBuilder.DOTB_TAB, new ResourceLocation("dawnoftimebuilder", "dotblocks/japanese"), new ItemStack(((Item)DoTBItemsRegistry.JAPANESE.get()).asItem()));
		register(DawnOfTimeBuilder.DOTB_TAB, new ResourceLocation("dawnoftimebuilder", "dotblocks/pre_columbian"), new ItemStack(((Item)DoTBItemsRegistry.PRE_COLUMBIAN.get()).asItem()));
		register(DawnOfTimeBuilder.DOTB_TAB, new ResourceLocation("dawnoftimebuilder", "dotblocks/roman"), new ItemStack(((Item)DoTBItemsRegistry.ROMAN.get()).asItem()));
	}
