...
import static net.minecraft.block.Blocks.CUT_SANDSTONE_SLAB;
...
import static net.minecraft.block.Blocks.LIGHT_GRAY_BED;
...
import static net.minecraft.block.Blocks.SANDSTONE_SLAB;
import static net.minecraft.block.Blocks.SMOOTH_SANDSTONE;
import static net.minecraft.block.Blocks.SMOOTH_SANDSTONE_SLAB;
...
public class DoTBBlocksRegistry {
	...
	public static final RegistryObject<Block> CRIMSON_PLANKS_EDGE = reg("crimson_planks_edge", new EdgeBlock(AbstractBlock.Properties.copy(CRIMSON_PLANKS)).setBurnable());
	...
	public static final RegistryObject<Block> WAXED_OAK_SHUTTER = reg("waxed_oak_shutters", new ShutterBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> WAXED_OAK_SMALL_SHUTTER = reg("waxed_oak_small_shutters", new SmallShutterBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	...
	public static final RegistryObject<Block> WAXED_OAK_FENCE_GATE = reg("waxed_oak_fence_gate", new FenceGateBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> CHARRED_SPRUCE_FENCE_GATE = reg("charred_spruce_fence_gate", new FenceGateBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> IKEBANA_FLOWER_POT = reg("ikebana_flower_pot", new SidedFlowerPotBlock(null));
	...
	public static final RegistryObject<Block> BIG_FLOWER_POT = reg("big_flower_pot", new BigFlowerPotBlock(AbstractBlock.Properties.copy(CLAY)));
	public static final RegistryObject<Block> MARBLE_BIG_FLOWER_POT = reg("marble_big_flower_pot", new MarbleBigFlowerPotBlock(AbstractBlock.Properties.copy(SANDSTONE)));
		...
		if(item != null){
			if(item instanceof IHasFlowerPot){
				...
				if(itemForPot.hasFlowerPot()){
					...
					finalReg(potName, potBlock);
					DoTBItemsRegistry.finalReg(potName, new BlockItem(potBlock, new Item.Properties().tab(DOTB_TAB)));
