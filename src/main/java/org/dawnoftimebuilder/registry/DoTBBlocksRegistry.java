...
import org.dawnoftimebuilder.block.roman.MarbleSidedColumnBlock;
import org.dawnoftimebuilder.block.roman.MarbleStatueBlock;
import org.dawnoftimebuilder.block.roman.SandstoneColumnBlock;
import org.dawnoftimebuilder.block.roman.SandstoneSidedColumnBlock;
...
public class DoTBBlocksRegistry
{
	...
	public static final RegistryObject<Block>	THATCH_WHEAT			= DoTBBlocksRegistry.reg("thatch_wheat",
			new BlockDoTB(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.COLOR_YELLOW).strength(1.0F).sound(SoundType.GRASS)).setBurnable(80, 30));
	public static final RegistryObject<Block>	THATCH_WHEAT_EDGE		= DoTBBlocksRegistry.reg("thatch_wheat_edge",
			new EdgeBlock(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.COLOR_YELLOW).strength(1.0F).sound(SoundType.GRASS)).setBurnable(80, 30));
	public static final RegistryObject<Block>	THATCH_WHEAT_PLATE		= DoTBBlocksRegistry.reg("thatch_wheat_plate",
			new PlateBlock(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.COLOR_YELLOW).strength(1.0F).sound(SoundType.GRASS)).setBurnable(80, 30));
	public static final RegistryObject<Block>	THATCH_WHEAT_SLAB		= DoTBBlocksRegistry.reg("thatch_wheat_slab",
			new SlabBlockDoTB(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.COLOR_YELLOW).strength(1.0F).sound(SoundType.GRASS)).setBurnable(80, 30));
	public static final RegistryObject<Block>	THATCH_WHEAT_STAIRS		= DoTBBlocksRegistry.reg("thatch_wheat_stairs",
			new StairsBlockDoTB(DoTBBlocksRegistry.THATCH_WHEAT, AbstractBlock.Properties.of(Material.GRASS, MaterialColor.COLOR_YELLOW).strength(1.0F).sound(SoundType.GRASS)).setBurnable(80, 30));
	public static final RegistryObject<Block>	THATCH_BAMBOO			= DoTBBlocksRegistry.reg("thatch_bamboo",
			new BlockDoTB(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.COLOR_YELLOW).strength(1.0F).sound(SoundType.GRASS)).setBurnable(40, 30));
	public static final RegistryObject<Block>	THATCH_BAMBOO_EDGE		= DoTBBlocksRegistry.reg("thatch_bamboo_edge",
			new EdgeBlock(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.COLOR_YELLOW).strength(1.0F).sound(SoundType.GRASS)).setBurnable(40, 30));
	public static final RegistryObject<Block>	THATCH_BAMBOO_PLATE		= DoTBBlocksRegistry.reg("thatch_bamboo_plate",
			new PlateBlock(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.COLOR_YELLOW).strength(1.0F).sound(SoundType.GRASS)).setBurnable(40, 30));
	public static final RegistryObject<Block>	THATCH_BAMBOO_SLAB		= DoTBBlocksRegistry.reg("thatch_bamboo_slab",
			new SlabBlockDoTB(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.COLOR_YELLOW).strength(1.0F).sound(SoundType.GRASS)).setBurnable(40, 30));
	public static final RegistryObject<Block>	THATCH_BAMBOO_STAIRS	= DoTBBlocksRegistry.reg("thatch_bamboo_stairs",
			new StairsBlockDoTB(DoTBBlocksRegistry.THATCH_BAMBOO, AbstractBlock.Properties.of(Material.GRASS, MaterialColor.COLOR_YELLOW).strength(1.0F).sound(SoundType.GRASS)).setBurnable(40, 30));
	...
	public static final RegistryObject<Block>	FIREPLACE				= DoTBBlocksRegistry.reg("fireplace",
			new FireplaceBlock(AbstractBlock.Properties.of(Material.STONE).strength(1.5F, 6.0F).lightLevel(DoTBBlocksRegistry.litBlockEmission(15))));
	...
	public static final RegistryObject<Block>	LIMESTONE_BRICKS_STAIRS					= DoTBBlocksRegistry.reg("limestone_bricks_stairs",
			new StairsBlockDoTB(DoTBBlocksRegistry.LIMESTONE_BRICKS, AbstractBlock.Properties.copy(Blocks.STONE_BRICKS)));
	...
	public static final RegistryObject<Block>	LIMESTONE_GARGOYLE						= DoTBBlocksRegistry.reg("limestone_gargoyle",
	...
	public static final RegistryObject<Block>	LIMESTONE_FIREPLACE						= DoTBBlocksRegistry.reg("limestone_fireplace",
			new MultiblockFireplaceBlock(AbstractBlock.Properties.copy(Blocks.STONE_BRICKS).noOcclusion().lightLevel(DoTBBlocksRegistry.litBlockEmission(15))));
	...
	public static final RegistryObject<Block>	ROOFING_SLATES_STAIRS					= DoTBBlocksRegistry.reg("roofing_slates_stairs",
	...
	public static final RegistryObject<Block>	FLAT_ROOF_TILES_STAIRS				= DoTBBlocksRegistry.reg("flat_roof_tiles_stairs",
			new StairsBlockDoTB(DoTBBlocksRegistry.FLAT_ROOF_TILES, AbstractBlock.Properties.copy(Blocks.STONE_BRICKS)));
	...
	public static final RegistryObject<Block>	STONE_BRICKS_FIREPLACE				= DoTBBlocksRegistry.reg("stone_bricks_fireplace",
			new MultiblockFireplaceBlock(AbstractBlock.Properties.copy(Blocks.STONE_BRICKS).noOcclusion().lightLevel(DoTBBlocksRegistry.litBlockEmission(15))));
	...
	public static final RegistryObject<Block>	STONE_BRICKS_MASONRY_STAIRS			= DoTBBlocksRegistry.reg("stone_bricks_masonry_stairs",
			new StairsBlockDoTB(DoTBBlocksRegistry.STONE_BRICKS_MASONRY, AbstractBlock.Properties.copy(Blocks.STONE_BRICKS)));
	...
	public static final RegistryObject<Block>	WAXED_OAK_FRAMED_RAMMED_DIRT		= DoTBBlocksRegistry.reg("waxed_oak_framed_rammed_dirt",
			new BlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block>	WAXED_OAK_FRAMED_RAMMED_DIRT_PILLAR	= DoTBBlocksRegistry.reg("waxed_oak_framed_rammed_dirt_pillar",
			new RotatedPillarBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_PLANKS					= DoTBBlocksRegistry.reg("waxed_oak_planks",
			new BlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_DOOR						= DoTBBlocksRegistry.reg("waxed_oak_door",
			new DoorBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD).noOcclusion()));
	public static final RegistryObject<Block>	WAXED_OAK_TRAPDOOR					= DoTBBlocksRegistry.reg("waxed_oak_trapdoor",
			new TrapDoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD).noOcclusion()));
	public static final RegistryObject<Block>	WAXED_OAK_SHUTTER					= DoTBBlocksRegistry.reg("waxed_oak_shutters",
			new ShutterBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block>	WAXED_OAK_LOG_STRIPPED				= DoTBBlocksRegistry.reg("waxed_oak_log_stripped",
			new RotatedPillarBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_BALUSTER					= DoTBBlocksRegistry.reg("waxed_oak_baluster",
			new BalusterBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD).noOcclusion()));
	public static final RegistryObject<Block>	WAXED_OAK_BEAM						= DoTBBlocksRegistry.reg("waxed_oak_beam",
			new BeamBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_SUPPORT_BEAM				= DoTBBlocksRegistry.reg("waxed_oak_support_beam",
			new SupportBeamBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_SUPPORT_SLAB				= DoTBBlocksRegistry.reg("waxed_oak_support_slab",
			new SupportSlabBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_SMALL_SHUTTER				= DoTBBlocksRegistry.reg("waxed_oak_small_shutters",
			new SmallShutterBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_TIMBER_FRAME				= DoTBBlocksRegistry.reg("waxed_oak_timber_frame",
			new BlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_TIMBER_FRAME_CORNER		= DoTBBlocksRegistry.reg("waxed_oak_timber_frame_corner",
			new WaxedOakTimberFrameCornerBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_TIMBER_FRAME_CROSSED		= DoTBBlocksRegistry.reg("waxed_oak_timber_frame_crossed",
			new BlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_TIMBER_FRAME_PILLAR		= DoTBBlocksRegistry.reg("waxed_oak_timber_frame_pillar",
			new RotatedPillarBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_TIMBER_FRAME_SQUARED		= DoTBBlocksRegistry.reg("waxed_oak_timber_frame_squared",
			new BlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_FENCE						= DoTBBlocksRegistry.reg("waxed_oak_fence",
			new FenceBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block>	WAXED_OAK_FENCE_GATE				= DoTBBlocksRegistry.reg("waxed_oak_fence_gate",
			new FenceGateBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block>	WAXED_OAK_WALL						= DoTBBlocksRegistry.reg("waxed_oak_wall",
			new WallBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block>	WAXED_OAK_PERGOLA					= DoTBBlocksRegistry.reg("waxed_oak_pergola",
			new PergolaBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_LATTICE					= DoTBBlocksRegistry.reg("waxed_oak_lattice",
			new LatticeBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD).noOcclusion()).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_PLANKS_EDGE				= DoTBBlocksRegistry.reg("waxed_oak_planks_edge",
			new EdgeBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_PLANKS_PLATE				= DoTBBlocksRegistry.reg("waxed_oak_planks_plate",
			new PlateBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_PLANKS_SLAB				= DoTBBlocksRegistry.reg("waxed_oak_planks_slab",
			new SlabBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_PLANKS_STAIRS				= DoTBBlocksRegistry.reg("waxed_oak_planks_stairs",
			new StairsBlockDoTB(DoTBBlocksRegistry.WAXED_OAK_PLANKS, AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	WAXED_OAK_CHANDELIER				= DoTBBlocksRegistry.reg("waxed_oak_chandelier",
			new WaxedOakChandelierBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD).noOcclusion().lightLevel(DoTBBlocksRegistry.litBlockEmission(15))));
	public static final RegistryObject<Block>	WAXED_OAK_CHAIR						= DoTBBlocksRegistry.reg("waxed_oak_chair",
			new WaxedOakChairBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD).noOcclusion(), 11.0F));
	public static final RegistryObject<Block>	WAXED_OAK_TABLE						= DoTBBlocksRegistry.reg("waxed_oak_table",
			new WaxedOakTableBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD).noOcclusion()));
	public static final RegistryObject<Block>	IVY									= DoTBBlocksRegistry.reg("ivy",
			new IvyBlock(AbstractBlock.Properties.of(Material.REPLACEABLE_PLANT).noCollission().randomTicks().strength(0.2F).sound(SoundType.VINE)));
	public static final RegistryObject<Block>	GERANIUM_PINK						= DoTBBlocksRegistry.reg("geranium_pink",
			new GeraniumBlock(AbstractBlock.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.GRASS)));
	...
	// Japanese
	public static final RegistryObject<Block>	CHARRED_SPRUCE_PLANKS				= DoTBBlocksRegistry.reg("charred_spruce_planks",
			new BlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_LOG_STRIPPED			= DoTBBlocksRegistry.reg("charred_spruce_log_stripped",
			new RotatedPillarBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_PLANKS_EDGE			= DoTBBlocksRegistry.reg("charred_spruce_planks_edge",
			new EdgeBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_PLANKS_PLATE			= DoTBBlocksRegistry.reg("charred_spruce_planks_plate",
			new PlateBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_PLANKS_SLAB			= DoTBBlocksRegistry.reg("charred_spruce_planks_slab",
			new SlabBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_PLANKS_STAIRS		= DoTBBlocksRegistry.reg("charred_spruce_planks_stairs",
			new StairsBlockDoTB(DoTBBlocksRegistry.CHARRED_SPRUCE_PLANKS, AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_BOARDS				= DoTBBlocksRegistry.reg("charred_spruce_boards",
			new BlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_DOOR					= DoTBBlocksRegistry.reg("charred_spruce_door",
			new DoorBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD).noOcclusion()));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_TRAPDOOR				= DoTBBlocksRegistry.reg("charred_spruce_trapdoor",
			new TrapDoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD).noOcclusion()));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_SHUTTERS				= DoTBBlocksRegistry.reg("charred_spruce_shutters",
			new CharredSpruceShuttersBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD).noOcclusion()));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_TALL_SHUTTERS		= DoTBBlocksRegistry.reg("charred_spruce_tall_shutters",
			new CharredSpruceTallShuttersBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD).noOcclusion()));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_FOUNDATION			= DoTBBlocksRegistry.reg("charred_spruce_foundation",
			new BlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_FOUNDATION_SLAB		= DoTBBlocksRegistry.reg("charred_spruce_foundation_slab",
			new SlabBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_WALL					= DoTBBlocksRegistry.reg("charred_spruce_wall",
			new WallBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_FENCE				= DoTBBlocksRegistry.reg("charred_spruce_fence",
			new FenceBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_FENCE_GATE			= DoTBBlocksRegistry.reg("charred_spruce_fence_gate",
			new FenceGateBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_RAILING				= DoTBBlocksRegistry.reg("charred_spruce_railing",
			new CharredSpruceRailingBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD).noOcclusion()));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_FANCY_RAILING		= DoTBBlocksRegistry.reg("charred_spruce_fancy_railing",
			new CharredSpruceFancyRailingBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD).noOcclusion()));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_PERGOLA				= DoTBBlocksRegistry.reg("charred_spruce_pergola",
			new PergolaBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_LATTICE				= DoTBBlocksRegistry.reg("charred_spruce_lattice",
			new LatticeBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD).noOcclusion()).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_SUPPORT_SLAB			= DoTBBlocksRegistry.reg("charred_spruce_support_slab",
			new SupportSlabBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_SUPPORT_BEAM			= DoTBBlocksRegistry.reg("charred_spruce_support_beam",
			new SupportBeamBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_BEAM					= DoTBBlocksRegistry.reg("charred_spruce_beam",
			new BeamBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	public static final RegistryObject<Block>	CHARRED_SPRUCE_TIMBER_FRAME			= DoTBBlocksRegistry.reg("charred_spruce_timber_frame",
			new BlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	CHARRED_SPRUCE_TIMBER_FRAME_PILLAR	= DoTBBlocksRegistry.reg("charred_spruce_timber_frame_pillar",
			new RotatedPillarBlockDoTB(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable());
	public static final RegistryObject<Block>	RED_PAINTED_BEAM					= DoTBBlocksRegistry.reg("red_painted_beam",
			new BeamBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD)).setBurnable(2, 3));
	...
	public static final RegistryObject<Block>	GRAY_ROOF_TILES_STAIRS				= DoTBBlocksRegistry.reg("gray_roof_tiles_stairs",
			new StairsBlockDoTB(DoTBBlocksRegistry.GRAY_ROOF_TILES, AbstractBlock.Properties.copy(Blocks.STONE_BRICKS)));
	...
	public static final RegistryObject<Block>	CHARRED_SPRUCE_ROOF_SUPPORT			= DoTBBlocksRegistry.reg("charred_spruce_roof_support",
			new MixedRoofSupportBlock(DoTBBlocksRegistry.GRAY_ROOF_TILES_SLAB, AbstractBlock.Properties.copy(Blocks.STONE_BRICKS).noOcclusion()));
	...
	public static final RegistryObject<Block>	STEPPING_STONES_SLAB				= DoTBBlocksRegistry.reg("stepping_stones_slab",
			new SlabBlockDoTB(AbstractBlock.Properties.of(Material.SAND, MaterialColor.STONE).strength(1.2F).sound(SoundType.GRAVEL)));
	public static final RegistryObject<Block>	CURVED_RAKED_GRAVEL					= DoTBBlocksRegistry.reg("curved_raked_gravel",
			new HorizontalBlockDoTB(AbstractBlock.Properties.of(Material.SAND, MaterialColor.STONE).strength(1.0F).sound(SoundType.GRAVEL)));
	public static final RegistryObject<Block>	STRAIGHT_RAKED_GRAVEL				= DoTBBlocksRegistry.reg("straight_raked_gravel",
			new HorizontalAxisBlockDoTB(AbstractBlock.Properties.of(Material.SAND, MaterialColor.STONE).strength(1.0F).sound(SoundType.GRAVEL)));
	public static final RegistryObject<Block>	CAST_IRON_TEAPOT_GRAY				= DoTBBlocksRegistry.reg("cast_iron_teapot_gray",
			new CastIronTeapotBlock(AbstractBlock.Properties.of(Material.METAL).strength(1.0F).sound(SoundType.METAL).noOcclusion()));
	public static final RegistryObject<Block>	CAST_IRON_TEAPOT_GREEN				= DoTBBlocksRegistry.reg("cast_iron_teapot_green",
			new CastIronTeapotBlock(AbstractBlock.Properties.of(Material.METAL).strength(1.0F).sound(SoundType.METAL).noOcclusion()));
	public static final RegistryObject<Block>	CAST_IRON_TEAPOT_DECORATED			= DoTBBlocksRegistry.reg("cast_iron_teapot_decorated",
			new CastIronTeapotBlock(AbstractBlock.Properties.of(Material.METAL).strength(1.0F).sound(SoundType.METAL).noOcclusion()));
	public static final RegistryObject<Block>	CAST_IRON_TEACUP_GRAY				= DoTBBlocksRegistry.reg("cast_iron_teacup_gray",
			new CastIronTeacupBlock(AbstractBlock.Properties.of(Material.METAL).strength(1.0F).sound(SoundType.METAL).noOcclusion()));
	public static final RegistryObject<Block>	CAST_IRON_TEACUP_GREEN				= DoTBBlocksRegistry.reg("cast_iron_teacup_green",
			new CastIronTeacupBlock(AbstractBlock.Properties.of(Material.METAL).strength(1.0F).sound(SoundType.METAL).noOcclusion()));
	public static final RegistryObject<Block>	CAST_IRON_TEACUP_DECORATED			= DoTBBlocksRegistry.reg("cast_iron_teacup_decorated",
			new CastIronTeacupBlock(AbstractBlock.Properties.of(Material.METAL).strength(1.0F).sound(SoundType.METAL).noOcclusion()));
	...
	public static final RegistryObject<Block>	SPRUCE_LOW_TABLE					= DoTBBlocksRegistry.reg("spruce_low_table",
			new SpruceLowTableBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD).noOcclusion().lightLevel(DoTBBlocksRegistry.litBlockEmission(14))));
	public static final RegistryObject<Block>	SPRUCE_LEGLESS_CHAIR				= DoTBBlocksRegistry.reg("spruce_legless_chair",
			new SpruceLeglessChairBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BLACK).strength(2.0F, 6.0F).sound(SoundType.WOOD).noOcclusion(), 3.0F));
	...
	public static final RegistryObject<Block>	PAPER_FOLDING_SCREEN				= DoTBBlocksRegistry.reg("paper_folding_screen",
			new FoldingScreenBlock(AbstractBlock.Properties.copy(Blocks.WHITE_WOOL).strength(1.5F, 1.5F).noOcclusion()));
	public static final RegistryObject<Block>	RED_PAPER_LANTERN					= DoTBBlocksRegistry.reg("red_paper_lantern",
			new PaperLanternBlock(AbstractBlock.Properties.copy(Blocks.RED_WOOL).noOcclusion().noCollission().lightLevel(state -> 12)));
	...
	public static final RegistryObject<Block>	IRORI_FIREPLACE						= DoTBBlocksRegistry.reg("irori_fireplace",
			new IroriFireplaceBlock(AbstractBlock.Properties.copy(Blocks.SPRUCE_PLANKS).noOcclusion().lightLevel(DoTBBlocksRegistry.litBlockEmission(15))));
	...
	public static final RegistryObject<Block>	STICK_BUNDLE						= DoTBBlocksRegistry.reg("stick_bundle",
			new StickBundleBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.GRASS).noOcclusion()).setBurnable());
	...
	public static final RegistryObject<Block>	MORAQ_MOSAIC_RECESS				= DoTBBlocksRegistry.reg("moraq_mosaic_recess",
			new StairsBlockDoTB(DoTBBlocksRegistry.MORAQ_MOSAIC_TILES_DELICATE, AbstractBlock.Properties.copy(Blocks.BRICKS)));
	...
	public static final RegistryObject<Block>	PLASTERED_STONE_STAIRS						= DoTBBlocksRegistry.reg("plastered_stone_stairs",
	...
	public static final RegistryObject<Block>	RED_PLASTERED_STONE_STAIRS					= DoTBBlocksRegistry.reg("red_plastered_stone_stairs",
	...
	public static final RegistryObject<Block>	RED_SCULPTED_PLASTERED_STONE_FRIEZE			= DoTBBlocksRegistry.reg("red_sculpted_plastered_stone_frieze",
	...
	public static final RegistryObject<Block>	GREEN_ORNAMENTED_PLASTERED_STONE_FRIEZE		= DoTBBlocksRegistry.reg("green_ornamented_plastered_stone_frieze",
	...
	public static final RegistryObject<Block>	GREEN_SCULPTED_PLASTERED_STONE_FRIEZE		= DoTBBlocksRegistry.reg("green_sculpted_plastered_stone_frieze",
	...
	public static final RegistryObject<Block>	PLASTERED_STONE_CRESSET						= DoTBBlocksRegistry.reg("plastered_stone_cresset",
			new PlasteredStoneCressetBlock(AbstractBlock.Properties.copy(Blocks.STONE_BRICKS).noOcclusion().lightLevel(DoTBBlocksRegistry.litBlockEmission(15))));
	public static final RegistryObject<Block>	FEATHERED_SERPENT_SCULPTURE					= DoTBBlocksRegistry.reg("feathered_serpent_sculpture",
	...
	public static final RegistryObject<Block>	CUT_SANDSTONE_STAIRS						= DoTBBlocksRegistry.reg("cut_sandstone_stairs",
			new StairsBlock(Blocks.CUT_SANDSTONE::defaultBlockState, AbstractBlock.Properties.copy(Blocks.CUT_SANDSTONE)));
	...
	public static final RegistryObject<Block>	OCHRE_ROOF_TILES_STAIRS						= DoTBBlocksRegistry.reg("ochre_roof_tiles_stairs",
	...
	public static final RegistryObject<Block>	OCHRE_ROOF_TILES_SLAB						= DoTBBlocksRegistry.reg("ochre_roof_tiles_slab",
			new MixedSlabBlock(AbstractBlock.Properties.copy(Blocks.BRICKS)).addMixedBlockRecipe(Blocks.SANDSTONE_SLAB, DoTBBlocksRegistry.SANDSTONE_BOT_OCHRE_ROOF_TILES_TOP, false)
	...
	public static final RegistryObject<Block>	SANDSTONE_SIDED_COLUMN						= DoTBBlocksRegistry.reg("sandstone_sided_column", new SandstoneSidedColumnBlock(AbstractBlock.Properties.copy(Blocks.SANDSTONE)));
	...
	public static final RegistryObject<Block>	BIRCH_FANCY_FENCE							= DoTBBlocksRegistry.reg("birch_fancy_fence",
			new BalusterBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD).noOcclusion()));
	...
	public static final RegistryObject<Block>	MARBLE_FANCY_FENCE							= DoTBBlocksRegistry.reg("marble_fancy_fence",
			new BalusterBlock(AbstractBlock.Properties.of(Material.STONE, MaterialColor.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE).noOcclusion()));
	...
	/**
	 * A utility method to register a Block and its corresponding Item. By default, creates a BlockItem for the block passed in parameter. If the given Block is an instance of ICustomBlockItem, the custom Item is retrieved
	 * and registered (if not null). If the Item implements IHasFlowerPot, a new FlowerPotBlock and its corresponding BlockItem will be also registered.
	 *
