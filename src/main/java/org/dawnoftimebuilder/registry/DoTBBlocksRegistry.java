...
public class DoTBBlocksRegistry {
	...
	//General
    public static final Block ACACIA_PLANKS_EDGE = reg("acacia_planks_edge", new EdgeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final Block ACACIA_PLANKS_PLATE = reg("acacia_planks_plate", new PlateBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	...
	public static final Block BIRCH_PLANKS_PLATE = reg("birch_planks_plate", new PlateBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	...
	public static final Block CANDLESTICK = reg("candlestick", new CandlestickBlock(Material.IRON, 2.0F, 6.0F, SoundType.METAL));
	public static final Block DARK_OAK_PLANKS_EDGE = reg("dark_oak_planks_edge", new EdgeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final Block DARK_OAK_PLANKS_PLATE = reg("dark_oak_planks_plate", new PlateBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	...
	public static final Block JUNGLE_PLANKS_PLATE = reg("jungle_planks_plate", new PlateBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
    ...
    public static final Block OAK_PLANKS_EDGE = reg("oak_planks_edge", new EdgeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	...
	public static final Block SPRUCE_PLANKS_EDGE = reg("spruce_planks_edge", new EdgeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final Block SPRUCE_PLANKS_PLATE = reg("spruce_planks_plate", new PlateBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	...
	public static final Block THATCH_BAMBOO = reg("thatch_bamboo", new BlockDoTB(Material.ORGANIC, 1.0F, 1.0F, SoundType.PLANT).setBurnable(40, 30));
	...
	public static final Block FIREPLACE = reg("fireplace", new FireplaceBlock(Material.ROCK,1.5F, 6.0F, SoundType.STONE));
	public static final Block IRON_PORTCULLIS = reg("iron_portcullis", new PortcullisBlock(Material.IRON, 5.0F, 6.0F, SoundType.METAL));

	//French
	public static final Block COBBLED_LIMESTONE = reg("cobbled_limestone", new BlockDoTB(Material.ROCK, 2.0F, 6.0F, SoundType.STONE));
	public static final Block LIMESTONE_BRICKS = reg("limestone_bricks", new BlockDoTB(Material.ROCK,1.5F, 6.0F, SoundType.STONE));
	...
	public static final Block LATTICE_GLASS = reg("lattice_glass", new GlassBlockDoTB(Material.GLASS, 1.0F, 1.0F, SoundType.GLASS));
	public static final Block LATTICE_GLASS_PANE = reg("lattice_glass_pane", new PaneBlockDoTB(Material.GLASS, 1.0F, 1.0F, SoundType.GLASS, BlockRenderLayer.TRANSLUCENT));
	public static final Block LATTICE_WAXED_OAK_WINDOW = reg("lattice_waxed_oak_window", new SidedWindowBlock(Material.GLASS, 2.0F, 3.0F, SoundType.GLASS));
	public static final Block LATTICE_STONE_BRICKS_WINDOW = reg("lattice_stone_bricks_window", new LatticeStoneBricksWindowBlock(Material.ROCK, 1.5F, 6.0F, SoundType.GLASS));
	public static final Block STONE_BRICKS_ARROWSLIT = reg("stone_bricks_arrowslit", new StoneBricksArrowslitBlock(Material.ROCK, 1.5F, 6.0F, SoundType.STONE));
	public static final Block STONE_BRICKS_CHIMNEY = reg("stone_bricks_chimney", new StoneBricksChimneyBlock(Material.ROCK, 1.5F, 6.0F, SoundType.STONE));
	public static final Block STONE_BRICKS_EDGE = reg("stone_bricks_edge", new EdgeBlock(STONE_BRICKS));
	public static final Block STONE_BRICKS_FIREPLACE = reg("stone_bricks_fireplace", new MultiblockFireplaceBlock(Material.ROCK, 2.0F, 6.0F, SoundType.STONE));
	public static final Block STONE_BRICKS_MACHICOLATION = reg("stone_bricks_machicolation", new StoneBricksMachicolationBlock(Material.ROCK, 1.5F, 6.0F, SoundType.STONE));
	public static final Block STONE_BRICKS_PLATE = reg("stone_bricks_plate", new PlateBlock(STONE_BRICKS));
	public static final Block WAXED_OAK_FRAMED_RAMMED_DIRT = reg("waxed_oak_framed_rammed_dirt", new BlockDoTB(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_DOOR = reg("waxed_oak_door", new DoorBlockDoTB(Material.WOOD, 1.5F, 6.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_TRAPDOOR = reg("waxed_oak_trapdoor", new TrapDoorBlockDoTB(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD));
	public static final Block WAXED_OAK_SHUTTERS = reg("waxed_oak_shutters", new ShuttersBlock(Material.WOOD, 2.0F, 2.0F, SoundType.WOOD));
	public static final Block WAXED_OAK_LOG_STRIPPED = reg("waxed_oak_log_stripped", new RotatedPillarBlockDoTB(Material.WOOD, 2.5F, 5.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_BEAM = reg("waxed_oak_beam", new BeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_SUPPORT_BEAM = reg("waxed_oak_support_beam", new SupportBeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_SUPPORT_SLAB = reg("waxed_oak_support_slab", new SupportSlabBlock(Material.WOOD, 1.5F, 3.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_SMALL_SHUTTERS = reg("waxed_oak_small_shutters", new SmallShuttersBlock(Material.WOOD, 2.0F, 2.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_TIMBER_FRAME = reg("waxed_oak_timber_frame", new BlockDoTB(Material.WOOD, 3.0F, 5.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_TIMBER_FRAME_CORNER = reg("waxed_oak_timber_frame_corner", new WaxedOakTimberFrameCornerBlock(Material.WOOD, 3.0F, 5.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_TIMBER_FRAME_CROSSED = reg("waxed_oak_timber_frame_crossed", new BlockDoTB(Material.WOOD, 3.0F, 5.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_TIMBER_FRAME_PILLAR = reg("waxed_oak_timber_frame_pillar", new RotatedPillarBlockDoTB(Material.WOOD, 3.0F, 5.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_TIMBER_FRAME_SQUARED = reg("waxed_oak_timber_frame_squared", new BlockDoTB(Material.WOOD, 3.0F, 5.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_FENCE = reg("waxed_oak_fence", new FenceBlockDoTB(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_WALL = reg("waxed_oak_wall", new WallBlockDoTB(Material.WOOD, 1.5F, 6.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_PERGOLA = reg("waxed_oak_pergola", new PergolaBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_LATTICE = reg("waxed_oak_lattice", new LatticeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final Block WAXED_OAK_PLANKS = reg("waxed_oak_planks", new BlockDoTB(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	...
	public static final Block WAXED_OAK_CHANDELIER = reg("waxed_oak_chandelier", new WaxedOakChandelier(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD));
	public static final Block WAXED_OAK_CHAIR = reg("waxed_oak_chair", new WaxedOakChairBlock(Material.WOOD, 2.0F, 2.0F, SoundType.WOOD, 11.0F));

	//Japanese
	public static final Block CHARRED_SPRUCE_LOG_STRIPPED = reg("charred_spruce_log_stripped", new RotatedPillarBlockDoTB(Material.WOOD, 2.5F, 5.0F, SoundType.WOOD).setBurnable(2, 3));
	public static final Block CHARRED_SPRUCE_PLANKS = reg("charred_spruce_planks", new BlockDoTB(Material.WOOD, 2.5F, 6.0F, SoundType.WOOD).setBurnable(2, 3));
	...
	public static final Block CHARRED_SPRUCE_BOARDS =reg("charred_spruce_boards", new BlockDoTB(Material.WOOD, 2.5F, 5.0F, SoundType.WOOD));
	public static final Block CHARRED_SPRUCE_DOOR = reg("charred_spruce_door", new DoorBlockDoTB(Material.WOOD, 1.5F, 6.0F, SoundType.WOOD));
	public static final Block CHARRED_SPRUCE_TRAPDOOR = reg("charred_spruce_trapdoor", new TrapDoorBlockDoTB(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD));
	public static final Block CHARRED_SPRUCE_SHUTTERS = reg("charred_spruce_shutters", new CharredSpruceShuttersBlock(Material.WOOD, 2.0F, 2.0F, SoundType.WOOD));
	public static final Block CHARRED_SPRUCE_TALL_SHUTTERS = reg("charred_spruce_tall_shutters", new CharredSpruceTallShuttersBlock(Material.WOOD, 2.0F, 2.0F, SoundType.WOOD));
	public static final Block CHARRED_SPRUCE_FOUNDATION = reg("charred_spruce_foundation", new BlockDoTB(Material.WOOD, 2.5F, 5.0F, SoundType.WOOD).setBurnable(2, 3));
	public static final Block CHARRED_SPRUCE_FOUNDATION_SLAB = reg("charred_spruce_foundation_slab", new SlabBlockDoTB(Material.WOOD, 2.5F, 5.0F, SoundType.WOOD).setBurnable(2, 3));
	public static final Block CHARRED_SPRUCE_WALL = reg("charred_spruce_wall", new WallBlockDoTB(Material.WOOD, 2.5F, 5.0F, SoundType.WOOD).setBurnable(2, 10));
	public static final Block CHARRED_SPRUCE_FENCE = reg("charred_spruce_fence", new FenceBlockDoTB(Material.WOOD, 2.5F, 5.0F, SoundType.WOOD).setBurnable(2, 10));
	public static final Block CHARRED_SPRUCE_RAILING = reg("charred_spruce_railing", new CharredSpruceRailingBlock(Material.WOOD, 2.0F, 2.0F, SoundType.WOOD).setBurnable());
	public static final Block CHARRED_SPRUCE_PERGOLA = reg("charred_spruce_pergola", new PergolaBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable(2, 3));
	public static final Block CHARRED_SPRUCE_LATTICE = reg("charred_spruce_lattice", new LatticeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable(2, 3));
	public static final Block CHARRED_SPRUCE_SUPPORT_SLAB = reg("charred_spruce_support_slab", new SupportSlabBlock(Material.WOOD, 1.5F, 3.0F, SoundType.WOOD).setBurnable(2, 3));
	public static final Block CHARRED_SPRUCE_SUPPORT_BEAM = reg("charred_spruce_support_beam", new SupportBeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable(2, 3));
	public static final Block CHARRED_SPRUCE_BEAM = reg("charred_spruce_beam", new BeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable(2, 3));
	public static final Block CHARRED_SPRUCE_TIMBER_FRAME = reg("charred_spruce_timber_frame", new BlockDoTB(Material.WOOD, 3.0F, 6.0F, SoundType.WOOD).setBurnable());
	public static final Block CHARRED_SPRUCE_TIMBER_FRAME_PILLAR = reg("charred_spruce_timber_frame_pillar", new RotatedPillarBlockDoTB(Material.WOOD, 3.0F, 6.0F, SoundType.WOOD).setBurnable());
	public static final Block RED_PAINTED_BEAM = reg("red_painted_beam", new BeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable(2, 3));
	public static final Block GRAY_ROOF_TILES = reg("gray_roof_tiles", new BlockDoTB(Material.ROCK,1.5F, 5.0F, SoundType.STONE));
	...
	public static final Block GRAY_ROOF_TILES_WALL = reg("gray_roof_tiles_wall", new WallBlockDoTB(Material.ROCK,1.5F, 5.0F, SoundType.STONE));
	...
	public static final Block CAST_IRON_TEAPOT_GRAY = reg("cast_iron_teapot_gray", new CastIronTeapotBlock(Material.IRON, 0.8F, 0.8F, SoundType.METAL));
	public static final Block CAST_IRON_TEAPOT_GREEN = reg("cast_iron_teapot_green", new CastIronTeapotBlock(Material.IRON, 0.8F, 0.8F, SoundType.METAL));
	public static final Block CAST_IRON_TEAPOT_DECORATED = reg("cast_iron_teapot_decorated", new CastIronTeapotBlock(Material.IRON, 0.8F, 0.8F, SoundType.METAL));
	public static final Block CAST_IRON_TEACUP_GRAY = reg("cast_iron_teacup_gray", new CastIronTeacupBlock(Material.IRON, 0.6F, 0.6F, SoundType.METAL));
	public static final Block CAST_IRON_TEACUP_GREEN = reg("cast_iron_teacup_green", new CastIronTeacupBlock(Material.IRON, 0.6F, 0.6F, SoundType.METAL));
	public static final Block CAST_IRON_TEACUP_DECORATED = reg("cast_iron_teacup_decorated", new CastIronTeacupBlock(Material.IRON, 0.6F, 0.6F, SoundType.METAL));
	public static final Block BAMBOO_DRYING_TRAY = reg("bamboo_drying_tray", new DryerBlock(Material.WOOD, 1.0F, 1.0F, SoundType.WOOD));
	public static final Block CAMELLIA = reg("camellia", new GrowingBushBlock("camellia_seeds", Plains, 3));
	public static final Block MULBERRY = reg("mulberry", new MulberryBlock("mulberry", Plains, 3, 2, DoTBFoods.MULBERRY));
	public static final Block IKEBANA_FLOWER_POT = reg("ikebana_flower_pot", new IkebanaFlowerPotBlock(Material.CLAY, 2.0F, 2.0F, SoundType.GROUND));
	public static final Block SPRUCE_LOW_TABLE = reg("spruce_low_table" ,new SpruceLowTableBlock(Material.WOOD, 2.0F, 2.0F, SoundType.WOOD));
	public static final Block SPRUCE_LEGLESS_CHAIR = reg("spruce_legless_chair", new SpruceLeglessChairBlock(Material.WOOD, 2.0F, 2.0F, SoundType.WOOD, 3.0F));
	public static final Block WHITE_LITTLE_FLAG = reg("white_little_flag", new LittleFlagBlock(Material.WOOL, 0.8F, 0.8F, SoundType.CLOTH, BlockRenderLayer.CUTOUT_MIPPED));
	public static final Block PAPER_DOOR = reg("paper_door", new PaperDoorBlock(Material.WOOL, 2.0F, 2.0F, SoundType.CLOTH).setBurnable());
	public static final Block PAPER_WALL = reg("paper_wall", new PaneBlockDoTB(Material.WOOL, 1.0F, 1.0F, SoundType.CLOTH).setBurnable());
	public static final Block PAPER_WALL_FLAT = reg("paper_wall_flat", new PaneBlockDoTB(Material.WOOL, 1.0F, 1.0F, SoundType.CLOTH).setBurnable());
	public static final Block PAPER_WALL_WINDOWS = reg("paper_wall_window", new PaneBlockDoTB(Material.WOOL, 1.0F, 1.0F, SoundType.CLOTH).setBurnable());
	public static final Block PAPER_WALL_FLOWERY = reg("paper_wall_flowery", new PaneBlockDoTB(Material.WOOL, 1.0F, 1.0F, SoundType.CLOTH).setBurnable());
	public static final Block PAPER_FOLDING_SCREEN = reg("paper_folding_screen", new FoldingScreenBlock(Material.WOOL, 1.0F, 1.0F, SoundType.CLOTH).setBurnable());
	public static final Block RED_PAPER_LANTERN = reg("red_paper_lantern", new PaperLanternBlock(Material.WOOL, 0.5F, 0.5F, SoundType.CLOTH));
	public static final Block PAPER_LAMP = reg("paper_lamp", new PaperLampBlock(Material.WOOL, 2.0F, 1.5F, SoundType.CLOTH));
	...
	public static final Block MORAQ_MOSAIC_TILES_DELICATE = reg("moraq_mosaic_tiles_delicate", new BlockDoTB(Material.ROCK, 1.0F, 1.0F, SoundType.STONE));
	public static final Block MORAQ_MOSAIC_TILES_TRADITIONAL = reg("moraq_mosaic_tiles_traditional", new BlockDoTB(Material.ROCK, 1.0F, 1.0F, SoundType.STONE));
	...
	public static final Block PLASTERED_STONE_WINDOW = reg("plastered_stone_window", new PlasteredStoneWindowBlock(Material.ROCK, 1.5F, 6.0F, SoundType.STONE));
	public static final Block CHISELED_PLASTERED_STONE = reg("chiseled_plastered_stone", new BlockDoTB(Material.ROCK,1.5F, 6.0F, SoundType.STONE));
	...
	public static final Block ORNAMENTED_CHISELED_PLASTERED_STONE = reg("ornamented_chiseled_plastered_stone", new BlockDoTB(Material.ROCK,1.5F, 6.0F, SoundType.STONE));
	public static final Block RED_PLASTERED_STONE = reg("red_plastered_stone", new BlockDoTB(Material.ROCK,1.5F, 6.0F, SoundType.STONE));
	public static final Block RED_CHISELED_PLASTERED_STONE = reg("red_chiseled_plastered_stone", new BlockDoTB(Material.ROCK,1.5F, 6.0F, SoundType.STONE));
	public static final Block RED_ORNAMENTED_CHISELED_PLASTERED_STONE = reg("red_ornamented_chiseled_plastered_stone", new BlockDoTB(Material.ROCK,1.5F, 6.0F, SoundType.STONE));
	...
	public static final Block RED_SCULPTED_PLASTERED_STONE_FRIEZE = reg("red_sculpted_plastered_stone_frieze", new RedSculptedPlasteredStoneFriezeBlock(Material.ROCK,1.5F, 6.0F, SoundType.STONE));
	public static final Block GREEN_CHISELED_PLASTERED_STONE = reg("green_chiseled_plastered_stone", new BlockDoTB(Material.ROCK,1.5F, 6.0F, SoundType.STONE));
	public static final Block GREEN_ORNAMENTED_CHISELED_PLASTERED_STONE = reg("green_ornamented_chiseled_plastered_stone", new BlockDoTB(Material.ROCK,1.5F, 6.0F, SoundType.STONE));
	...
	public static final Block PLASTERED_STONE_CRESSET = reg("plastered_stone_cresset", new PlasteredStoneCressetBlock(Material.ROCK, 1.5F, 6.0F, SoundType.STONE));
	public static final Block FEATHERED_SERPENT_SCULPTURE = reg("feathered_serpent_sculpture", new FeatheredSerpentSculptureBlock(Material.ROCK, 1.5F, 6.0F, SoundType.STONE));
	public static final Block SERPENT_SCULPTED_COLUMN = reg("serpent_sculpted_column", new SerpentSculptedColumnBlock(Material.ROCK, 1.5F, 6.0F, SoundType.STONE));

	//Roman
	public static final Block OCHRE_ROOF_TILES = reg("ochre_roof_tiles", new BlockDoTB(Material.ROCK, 1.5F, 5.0F, SoundType.STONE));
	public static final Block OCHRE_ROOF_TILES_EDGE = reg("ochre_roof_tiles_edge", new EdgeBlock(Material.ROCK, 2.0F, 3.0F, SoundType.STONE));
	public static final Block OCHRE_ROOF_TILES_PLATE = reg("ochre_roof_tiles_plate", new PlateBlock(Material.ROCK, 2.0F, 3.0F, SoundType.STONE));
	public static final Block OCHRE_ROOF_TILES_STAIRS = reg("ochre_roof_tiles_stairs", new StairsBlockDoTB(OCHRE_ROOF_TILES));
	public static final Block OCHRE_ROOF_TILES_WALL = reg("ochre_roof_tiles_wall", new WallBlockDoTB(Material.ROCK, 1.5F, 6.0F, SoundType.STONE));
