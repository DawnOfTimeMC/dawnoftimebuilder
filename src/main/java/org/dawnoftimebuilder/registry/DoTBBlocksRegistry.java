...
public class DoTBBlocksRegistry {
	...
	public static final RegistryObject<Block>	STONE_BRICKS_CHIMNEY						= DoTBBlocksRegistry.reg("stone_bricks_chimney", new StoneBricksChimneyBlock(AbstractBlock.Properties.copy(Blocks.STONE_BRICKS)));
	...
	public static final RegistryObject<Block>	PAPER_WALL									= DoTBBlocksRegistry.reg("paper_wall", new PaneBlockDoTB(AbstractBlock.Properties.copy(Blocks.WHITE_WOOL).strength(1.5F, 1.5F)));
