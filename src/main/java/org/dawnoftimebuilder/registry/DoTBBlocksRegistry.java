...
public class DoTBBlocksRegistry {
	...
	//General
    public static final RegistryObject<Block> ACACIA_PLANKS_EDGE = reg("acacia_planks_edge", new EdgeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> ACACIA_PLANKS_PLATE = reg("acacia_planks_plate", new PlateBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> ACACIA_PERGOLA = reg("acacia_pergola", new PergolaBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> ACACIA_LATTICE = reg("acacia_lattice", new LatticeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> ACACIA_BEAM = reg("acacia_beam", new BeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> ACACIA_WALL = reg("acacia_wall", new WallBlockDoTB(Material.WOOD, 1.5F, 6.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> ACACIA_SUPPORT_BEAM = reg("acacia_support_beam", new SupportBeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> ACACIA_SUPPORT_SLAB = reg("acacia_support_slab", new SupportSlabBlock(Material.WOOD, 1.5F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> BIRCH_PLANKS_EDGE = reg("birch_planks_edge", new EdgeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> BIRCH_PLANKS_PLATE = reg("birch_planks_plate", new PlateBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> BIRCH_PERGOLA = reg("birch_pergola", new PergolaBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> BIRCH_LATTICE = reg("birch_lattice", new LatticeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> BIRCH_BEAM = reg("birch_beam", new BeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> BIRCH_WALL = reg("birch_wall", new WallBlockDoTB(Material.WOOD, 1.5F, 6.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> BIRCH_SUPPORT_BEAM = reg("birch_support_beam", new SupportBeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> BIRCH_SUPPORT_SLAB = reg("birch_support_slab", new SupportSlabBlock(Material.WOOD, 1.5F, 3.0F, SoundType.WOOD).setBurnable());
	...
	public static final RegistryObject<Block> DARK_OAK_PLANKS_EDGE = reg("dark_oak_planks_edge", new EdgeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> DARK_OAK_PLANKS_PLATE = reg("dark_oak_planks_plate", new PlateBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> DARK_OAK_PERGOLA = reg("dark_oak_pergola", new PergolaBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> DARK_OAK_LATTICE = reg("dark_oak_lattice", new LatticeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> DARK_OAK_BEAM = reg("dark_oak_beam", new BeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> DARK_OAK_WALL = reg("dark_oak_wall", new WallBlockDoTB(Material.WOOD, 1.5F, 6.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> DARK_OAK_SUPPORT_BEAM = reg("dark_oak_support_beam", new SupportBeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> DARK_OAK_SUPPORT_SLAB = reg("dark_oak_support_slab", new SupportSlabBlock(Material.WOOD, 1.5F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> JUNGLE_PLANKS_EDGE = reg("jungle_planks_edge", new EdgeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> JUNGLE_PLANKS_PLATE = reg("jungle_planks_plate", new PlateBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> JUNGLE_PERGOLA = reg("jungle_pergola", new PergolaBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> JUNGLE_LATTICE = reg("jungle_lattice", new LatticeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> JUNGLE_BEAM = reg("jungle_beam", new BeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> JUNGLE_WALL = reg("jungle_wall", new WallBlockDoTB(Material.WOOD, 1.5F, 6.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> JUNGLE_SUPPORT_BEAM = reg("jungle_support_beam", new SupportBeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> JUNGLE_SUPPORT_SLAB = reg("jungle_support_slab", new SupportSlabBlock(Material.WOOD, 1.5F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> OAK_PLANKS_PLATE = reg("oak_planks_plate", new PlateBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
    public static final RegistryObject<Block> OAK_PLANKS_EDGE = reg("oak_planks_edge", new EdgeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> OAK_PERGOLA = reg("oak_pergola", new PergolaBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> OAK_LATTICE = reg("oak_lattice", new LatticeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> OAK_BEAM = reg("oak_beam", new BeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> OAK_WALL = reg("oak_wall", new WallBlockDoTB(Material.WOOD, 1.5F, 6.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> OAK_SUPPORT_BEAM = reg("oak_support_beam", new SupportBeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> OAK_SUPPORT_SLAB = reg("oak_support_slab", new SupportSlabBlock(Material.WOOD, 1.5F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> RAMMED_DIRT = reg("rammed_dirt", new BlockDoTB(Material.DIRT, 0.7F, 0.7F, SoundType.GRAVEL));
	public static final RegistryObject<Block> SPRUCE_PLANKS_EDGE = reg("spruce_planks_edge", new EdgeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> SPRUCE_PLANKS_PLATE = reg("spruce_planks_plate", new PlateBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> SPRUCE_PERGOLA = reg("spruce_pergola", new PergolaBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> SPRUCE_LATTICE = reg("spruce_lattice", new LatticeBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> SPRUCE_BEAM = reg("spruce_beam", new BeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> SPRUCE_WALL = reg("spruce_wall", new WallBlockDoTB(Material.WOOD, 1.5F, 6.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> SPRUCE_SUPPORT_BEAM = reg("spruce_support_beam", new SupportBeamBlock(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD).setBurnable());
	public static final RegistryObject<Block> SPRUCE_SUPPORT_SLAB = reg("spruce_support_slab", new SupportSlabBlock(Material.WOOD, 1.5F, 3.0F, SoundType.WOOD).setBurnable());
	...
	public static final RegistryObject<Block> LATTICE_GLASS_PANE = reg("lattice_glass_pane", new PaneBlockDoTB(Material.GLASS, 1.0F, 1.0F, SoundType.GLASS, BlockRenderLayer.TRANSLUCENT));
	...
	public static final RegistryObject<Block> WAXED_OAK_TRAPDOOR = reg("waxed_oak_trapdoor", new TrapDoorBlockDoTB(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD));
	...
	public static final RegistryObject<Block> CHARRED_SPRUCE_TRAPDOOR = reg("charred_spruce_trapdoor", new TrapDoorBlockDoTB(Material.WOOD, 2.0F, 3.0F, SoundType.WOOD));
	...
	public static final RegistryObject<Block> WHITE_LITTLE_FLAG = reg("white_little_flag", new LittleFlagBlock(Material.WOOL, 0.8F, 0.8F, SoundType.WOOL, BlockRenderLayer.CUTOUT_MIPPED));
	...
	public static final RegistryObject<Block> WILD_MAIZE = reg("wild_maize", new WildMaizeBlock(Material.PLANT, 0.0F, 0.0F, SoundType.CROP));
	...
	public static final RegistryObject<Block> OCHRE_ROOF_TILES_SLAB = reg("ochre_roof_tiles_slab", new MixedSlabBlock(OCHRE_ROOF_TILES.get()).addMixedBlockRecipe((SlabBlock) SANDSTONE_SLAB, SANDSTONE_BOT_OCHRE_ROOF_TILES_TOP, false));
	...
	public static final RegistryObject<Block> WILD_GRAPE = reg("wild_grape", new WildPlantBlock(Material.PLANT, 0.0F, 0.0F, SoundType.CROP));
