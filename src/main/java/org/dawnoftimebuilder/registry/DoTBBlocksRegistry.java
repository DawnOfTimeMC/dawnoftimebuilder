...
public class DoTBBlocksRegistry {
	...
	public static final RegistryObject<Block> WAXED_OAK_FENCE_GATE = reg("waxed_oak_fence_gate", new FenceGateBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F, 5.0F).sound(SoundType.WOOD)));
