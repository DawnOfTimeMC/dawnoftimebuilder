...
public class DoTBBlocksRegistry {
	...
	public static final RegistryObject<Block> WAXED_OAK_DOOR = reg("waxed_oak_door", new DoorBlockDoTB(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())));
	public static final RegistryObject<Block> WAXED_OAK_TRAPDOOR = reg("waxed_oak_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())));
	public static final RegistryObject<Block> WAXED_OAK_SHUTTERS = reg("waxed_oak_shutters", new ShuttersBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())));
	public static final RegistryObject<Block> WAXED_OAK_LOG_STRIPPED = reg("waxed_oak_log_stripped", new RotatedPillarBlockDoTB(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_BEAM = reg("waxed_oak_beam", new BeamBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_SUPPORT_BEAM = reg("waxed_oak_support_beam", new SupportBeamBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_SUPPORT_SLAB = reg("waxed_oak_support_slab", new SupportSlabBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_SMALL_SHUTTERS = reg("waxed_oak_small_shutters", new SmallShuttersBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_TIMBER_FRAME = reg("waxed_oak_timber_frame", new BlockDoTB(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_TIMBER_FRAME_CORNER = reg("waxed_oak_timber_frame_corner", new WaxedOakTimberFrameCornerBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_TIMBER_FRAME_CROSSED = reg("waxed_oak_timber_frame_crossed", new BlockDoTB(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_TIMBER_FRAME_PILLAR = reg("waxed_oak_timber_frame_pillar", new RotatedPillarBlockDoTB(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_TIMBER_FRAME_SQUARED = reg("waxed_oak_timber_frame_squared", new BlockDoTB(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_FENCE = reg("waxed_oak_fence", new FenceBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())));
	public static final RegistryObject<Block> WAXED_OAK_WALL = reg("waxed_oak_wall", new WallBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())));
	public static final RegistryObject<Block> WAXED_OAK_PERGOLA = reg("waxed_oak_pergola", new PergolaBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_LATTICE = reg("waxed_oak_lattice", new LatticeBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get()).noOcclusion()).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_PLANKS_EDGE = reg("waxed_oak_planks_edge", new EdgeBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_PLANKS_PLATE = reg("waxed_oak_planks_plate", new PlateBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> WAXED_OAK_PLANKS_SLAB = reg("waxed_oak_planks_slab", new SlabBlockDoTB(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get())).setBurnable());
	...
	public static final RegistryObject<Block> WAXED_OAK_CHANDELIER = reg("waxed_oak_chandelier", new WaxedOakChandelier(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get()).noOcclusion()));
	public static final RegistryObject<Block> WAXED_OAK_CHAIR = reg("waxed_oak_chair", new WaxedOakChairBlock(AbstractBlock.Properties.copy(WAXED_OAK_PLANKS.get()).noOcclusion(), 11.0F));
	...
	public static final RegistryObject<Block> CHARRED_SPRUCE_LOG_STRIPPED = reg("charred_spruce_log_stripped", new RotatedPillarBlockDoTB(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable(2, 3));
	public static final RegistryObject<Block> CHARRED_SPRUCE_PLANKS_EDGE = reg("charred_spruce_planks_edge", new EdgeBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable(2, 3));
	public static final RegistryObject<Block> CHARRED_SPRUCE_PLANKS_PLATE = reg("charred_spruce_planks_plate", new PlateBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable(2, 3));
	public static final RegistryObject<Block> CHARRED_SPRUCE_PLANKS_SLAB = reg("charred_spruce_planks_slab", new SlabBlockDoTB(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable(2, 3));
	...
	public static final RegistryObject<Block> CHARRED_SPRUCE_BOARDS =reg("charred_spruce_boards", new BlockDoTB(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable(2, 3));
	public static final RegistryObject<Block> CHARRED_SPRUCE_DOOR = reg("charred_spruce_door", new DoorBlockDoTB(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())));
	public static final RegistryObject<Block> CHARRED_SPRUCE_TRAPDOOR = reg("charred_spruce_trapdoor", new TrapDoorBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())));
	public static final RegistryObject<Block> CHARRED_SPRUCE_SHUTTERS = reg("charred_spruce_shutters", new CharredSpruceShuttersBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get()).noOcclusion()));
	public static final RegistryObject<Block> CHARRED_SPRUCE_TALL_SHUTTERS = reg("charred_spruce_tall_shutters", new CharredSpruceTallShuttersBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get()).noOcclusion()));
	public static final RegistryObject<Block> CHARRED_SPRUCE_FOUNDATION = reg("charred_spruce_foundation", new BlockDoTB(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable(2, 3));
	public static final RegistryObject<Block> CHARRED_SPRUCE_FOUNDATION_SLAB = reg("charred_spruce_foundation_slab", new SlabBlockDoTB(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable(2, 3));
	public static final RegistryObject<Block> CHARRED_SPRUCE_WALL = reg("charred_spruce_wall", new WallBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())));
	public static final RegistryObject<Block> CHARRED_SPRUCE_FENCE = reg("charred_spruce_fence", new FenceBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())));
	public static final RegistryObject<Block> CHARRED_SPRUCE_RAILING = reg("charred_spruce_railing", new CharredSpruceRailingBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())));
	public static final RegistryObject<Block> CHARRED_SPRUCE_PERGOLA = reg("charred_spruce_pergola", new PergolaBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable(2, 3));
	public static final RegistryObject<Block> CHARRED_SPRUCE_LATTICE = reg("charred_spruce_lattice", new LatticeBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get()).noOcclusion()).setBurnable(2, 3));
	public static final RegistryObject<Block> CHARRED_SPRUCE_SUPPORT_SLAB = reg("charred_spruce_support_slab", new SupportSlabBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable(2, 3));
	public static final RegistryObject<Block> CHARRED_SPRUCE_SUPPORT_BEAM = reg("charred_spruce_support_beam", new SupportBeamBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable(2, 3));
	public static final RegistryObject<Block> CHARRED_SPRUCE_BEAM = reg("charred_spruce_beam", new BeamBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable(2, 3));
	public static final RegistryObject<Block> CHARRED_SPRUCE_TIMBER_FRAME = reg("charred_spruce_timber_frame", new BlockDoTB(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> CHARRED_SPRUCE_TIMBER_FRAME_PILLAR = reg("charred_spruce_timber_frame_pillar", new RotatedPillarBlockDoTB(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable());
	public static final RegistryObject<Block> RED_PAINTED_BEAM = reg("red_painted_beam", new BeamBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get())).setBurnable(2, 3));
	...
	public static final RegistryObject<Block> CHARRED_SPRUCE_ROOF_SUPPORT = reg("charred_spruce_roof_support", new MixedRoofSupportBlock((SlabBlock) GRAY_ROOF_TILES_SLAB.get(), AbstractBlock.Properties.copy(STONE_BRICKS)));
	...
	public static final RegistryObject<Block> STEPPING_STONES_SLAB = reg("stepping_stones_slab", new SlabBlockDoTB(AbstractBlock.Properties.copy(STEPPING_STONES.get())));
	...
	public static final RegistryObject<Block> CAST_IRON_TEAPOT_GREEN = reg("cast_iron_teapot_green", new CastIronTeapotBlock(AbstractBlock.Properties.copy(CAST_IRON_TEAPOT_GRAY.get())));
	public static final RegistryObject<Block> CAST_IRON_TEAPOT_DECORATED = reg("cast_iron_teapot_decorated", new CastIronTeapotBlock(AbstractBlock.Properties.copy(CAST_IRON_TEAPOT_GRAY.get())));
	public static final RegistryObject<Block> CAST_IRON_TEACUP_GRAY = reg("cast_iron_teacup_gray", new CastIronTeacupBlock(AbstractBlock.Properties.copy(CAST_IRON_TEAPOT_GRAY.get())));
	public static final RegistryObject<Block> CAST_IRON_TEACUP_GREEN = reg("cast_iron_teacup_green", new CastIronTeacupBlock(AbstractBlock.Properties.copy(CAST_IRON_TEAPOT_GRAY.get())));
	public static final RegistryObject<Block> CAST_IRON_TEACUP_DECORATED = reg("cast_iron_teacup_decorated", new CastIronTeacupBlock(AbstractBlock.Properties.copy(CAST_IRON_TEAPOT_GRAY.get())));
	...
	public static final RegistryObject<Block> SPRUCE_LOW_TABLE = reg("spruce_low_table" ,new SpruceLowTableBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get()).noOcclusion()));
	public static final RegistryObject<Block> SPRUCE_LEGLESS_CHAIR = reg("spruce_legless_chair", new SpruceLeglessChairBlock(AbstractBlock.Properties.copy(CHARRED_SPRUCE_PLANKS.get()).noOcclusion(), 3.0F));
	...
	public static final RegistryObject<Block> PAPER_DOOR = reg("paper_door", new PaperDoorBlock(AbstractBlock.Properties.copy(PAPER_WALL.get())));
	public static final RegistryObject<Block> PAPER_WALL_FLAT = reg("paper_wall_flat", new PaneBlockDoTB(AbstractBlock.Properties.copy(PAPER_WALL.get())));
	public static final RegistryObject<Block> PAPER_WALL_WINDOWS = reg("paper_wall_window", new PaneBlockDoTB(AbstractBlock.Properties.copy(PAPER_WALL.get())));
	public static final RegistryObject<Block> PAPER_WALL_FLOWERY = reg("paper_wall_flowery", new PaneBlockDoTB(AbstractBlock.Properties.copy(PAPER_WALL.get())));
	public static final RegistryObject<Block> PAPER_FOLDING_SCREEN = reg("paper_folding_screen", new FoldingScreenBlock(AbstractBlock.Properties.copy(PAPER_WALL.get())));
	...
	public static final RegistryObject<Block> OCHRE_ROOF_TILES_SLAB = reg("ochre_roof_tiles_slab", new MixedSlabBlock(AbstractBlock.Properties.copy(BRICKS)).addMixedBlockRecipe((SlabBlock) SANDSTONE_SLAB, SANDSTONE_BOT_OCHRE_ROOF_TILES_TOP.get(), false));
