...
public class DoTBItemsRegistry {
	...
	//General
	public static final RegistryObject<Item> SILKMOTH_SPAWN_EGG = reg("silkmoth_spawn_egg", new SpawnEggItem(SILKMOTH_ENTITY, 0xDBD8BD, 0xFEFEFC, (new Item.Properties()).tab(ItemGroup.TAB_MISC)));
	public static final RegistryObject<Item> JAPANESE_DRAGON_SPAWN_EGG = reg("japanese_dragon_spawn_egg", new SpawnEggItem(JAPANESE_DRAGON_ENTITY, 0xFFFFFF, 0xFFFFFF, (new Item.Properties()).tab(ItemGroup.TAB_MISC)));
