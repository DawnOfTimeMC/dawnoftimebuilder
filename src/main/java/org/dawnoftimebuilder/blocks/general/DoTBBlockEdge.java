...
public class DoTBBlockEdge extends DoTBBlock implements IWaterLoggable {
	...
	public DoTBBlockEdge(String name, Block.Properties properties) {
	...
	public DoTBBlockEdge(String name, Material materialIn, float hardness, float resistance) {
		this(name, Block.Properties.create(materialIn).hardnessAndResistance(hardness, resistance));
	}

	public DoTBBlockEdge(String name, Block block) {
	...
	private static VoxelShape[] makeShapes(boolean bottom) {
		VoxelShape vs_north_flat = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 8.0D, 8.0D);
		VoxelShape vs_east_flat = Block.makeCuboidShape(8.0D, 0.0D, 0.0D, 16.0D, 8.0D, 16.0D);
		VoxelShape vs_south_flat = Block.makeCuboidShape(0.0D, 0.0D, 8.0D, 16.0D, 8.0D, 16.0D);
		VoxelShape vs_west_flat = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 8.0D, 8.0D, 16.0D);
		VoxelShape vs_nw_corner = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 8.0D, 8.0D, 8.0D);
		VoxelShape vs_ne_corner = Block.makeCuboidShape(8.0D, 0.0D, 0.0D, 16.0D, 8.0D, 8.0D);
		VoxelShape vs_se_corner = Block.makeCuboidShape(8.0D, 0.0D, 8.0D, 16.0D, 8.0D, 16.0D);
		VoxelShape vs_sw_corner = Block.makeCuboidShape(0.0D, 0.0D, 8.0D, 8.0D, 8.0D, 16.0D);
