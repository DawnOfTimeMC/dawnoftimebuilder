...
public class DoTBBlockDoubleCrops extends DoTBBlockSoilCrops {

	public int growingAge;
	public VoxelShape[] SHAPES;
	public static final EnumProperty<Half> HALF = BlockStateProperties.HALF;
	
	public DoTBBlockDoubleCrops(String name, String seedName, PlantType plantType, int growingAge) {
	...
	public DoTBBlockDoubleCrops(String name, PlantType plantType, int growingAge){
