...
{
	public final static boolean isValidForPlacement(final IWorld worldIn, final BlockPos bottomCenterIn,
			final boolean isSaplingCallIn)
	{
	...
	public final static void placeFinalTreeIfPossible(final IWorld worldIn, final BlockPos centerPosIn)
	{
		if (MapleSaplingBlock.isValidForPlacement(worldIn, centerPosIn, true))
		{
			...
			worldIn.setBlock(centerPosIn, DoTBBlocksRegistry.MAPLE_RED_TRUNK.get().defaultBlockState()
			...
			for (int x = -1; x <= 1; x++)
			{
				for (int y = 0; y <= 1; y++)
				{
					for (int z = -1; z <= 1; z++)
					{
						final BlockPos newBlockPosition = new BlockPos(centerPosIn.getX() + x,
								centerPosIn.getY() + y + 1, centerPosIn.getZ() + z);

						worldIn.setBlock(newBlockPosition,
								DoTBBlocksRegistry.MAPLE_RED_LEAVES.get().defaultBlockState()
										...
										.setValue(MapleLeavesBlock.MULTIBLOCK_Z, z + 1),
								10);
					}
				}
			}
	...
	@Override
	public ActionResultType use(final BlockState p_225533_1_In, final World p_225533_2_In, final BlockPos p_225533_3_In,
			final PlayerEntity p_225533_4_In, final Hand p_225533_5_In, final BlockRayTraceResult p_225533_6_In)
	{
		...
		if (mainItem instanceof FlintAndSteelItem)
		{
			...
			{
				p_225533_2_In.setBlock(p_225533_3_In,
						DoTBBlocksRegistry.PAUSED_MAPLE_RED_SAPLING.get().defaultBlockState(), 35);
	...
	@Override
	public VoxelShape getShape(final BlockState p_220053_1_In, final IBlockReader p_220053_2_In,
			final BlockPos p_220053_3_In, final ISelectionContext p_220053_4_In)
	{
		return MapleSaplingBlock.SHAPE;
	}

	@Override
	public void generateOnPos(final IWorld world, final BlockPos centerPosIn, final BlockState state,
			final Random random)
	{
	...
	public void advanceTree(final ServerWorld p_226942_1_, final BlockPos p_226942_2_, final BlockState p_226942_3_,
			final Random p_226942_4_)
	{
	...
	@Override
	public boolean isValidBonemealTarget(final IBlockReader p_176473_1_, final BlockPos p_176473_2_,
			final BlockState p_176473_3_, final boolean p_176473_4_)
	{
		return true;
	}

	@Override
	public boolean isBonemealSuccess(final World p_180670_1_, final Random p_180670_2_, final BlockPos p_180670_3_,
			final BlockState p_180670_4_)
	{
		return p_180670_1_.random.nextFloat() < 0.45D;
	}

	@Override
	public void performBonemeal(final ServerWorld p_225535_1_, final Random p_225535_2_, final BlockPos p_225535_3_,
			final BlockState p_225535_4_)
	{
