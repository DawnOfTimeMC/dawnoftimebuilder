...
public class LatticeOakWindowBlock extends BlockDoTB {
    ...
    private boolean canConnectVertical(World worldIn, BlockPos pos) {
    	if(worldIn.getBlockState(pos.down()).getBlock() instanceof LatticeOakWindowBlock){
			return !(worldIn.getBlockState(pos.up()).getBlock() instanceof LatticeOakWindowBlock);
    	}
    	return false;
    }
    ...
    private boolean canConnectHorizontal(BlockState state, World worldIn, BlockPos pos) {
    	...
    	if(worldIn.getBlockState(pos).getBlock() instanceof LatticeOakWindowBlock){
