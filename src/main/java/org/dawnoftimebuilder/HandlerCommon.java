						...
						.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
								Feature.RANDOM_PATCH
										.configured(new BlockClusterFeatureConfig.Builder(
												...
												new DoTBBlockPlacer()).tries(DoTBConfig.RED_MAPLE_ROLLS.get())
				...
				generation
						.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
								Feature.RANDOM_PATCH
										.configured(new BlockClusterFeatureConfig.Builder(
												new SimpleBlockStateProvider(
														DoTBBlocksRegistry.BOXWOOD_BUSH.get().defaultBlockState()),
												new DoTBBlockPlacer()).tries(DoTBConfig.BOXWOOD_BUSH_ROLLS.get())
												.xspread(2).zspread(2).build())
										.decorated(Features.Placements.HEIGHTMAP_SQUARE));
			}
