...
public class CreativeInventoryFilters {
    ...
    private Button discord, curse, patreon, github;
    ...
    public void onScreenInit(GuiScreenEvent.InitGuiEvent.Post event) {
        if (event.getGui() instanceof CreativeScreen) {
            ...
            event.addWidget(this.discord = new SocialsButton(guiCenterX + 200, guiCenterY, "discord", button -> openLink("https://discord.gg/cteCdn9Hnf")));
            event.addWidget(this.curse = new SocialsButton(guiCenterX + 200, guiCenterY + 35, "curse", button -> openLink("https://www.curseforge.com/minecraft/mc-mods/dawn-of-time")));
            event.addWidget(this.patreon = new SocialsButton(guiCenterX + 200, guiCenterY + 70, "patreon", button -> openLink("https://www.patreon.com/dawnoftimemod")));
            event.addWidget(this.github = new SocialsButton(guiCenterX + 200, guiCenterY + 105, "github", button -> openLink("https://github.com/PierreChag/dawnoftimebuilder")));
    ...
    private void showButtons(CreativeScreen screen) {
