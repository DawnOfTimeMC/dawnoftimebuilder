...
public class DoTBUtils {
    ...
    /**
     * Helper method that returns a new {@link AxisAlignedBB} rotated for a given {@link Direction}
     * using an AxisAlignedBB oriented toward North
     */
	public static AxisAlignedBB getRotatedAABB(AxisAlignedBB AABB, Direction facing) {
		
		if (facing == Direction.UP||facing == Direction.DOWN||facing == Direction.NORTH) return AABB;
		else {
